...
final List<EnemyInfo> yarniaBestiary = [
  EnemyInfo(
    ...
    hp: 75, mp: 0, atk: 15, spd: 60, def: "25%", crit: "10%", eva: "5%",
  ),
  EnemyInfo(
    name: "Velocipastor",
    biome: "Dunas Doradas",
    ...
    hp: 40, mp: 0, atk: 20, spd: 130, def: "0%", crit: "15%", eva: "25%",
  ),
  EnemyInfo(
    ...
    hp: 120, mp: 0, atk: 10, spd: 90, def: "20%", crit: "5%", eva: "15%",
  ),
  EnemyInfo(
    ...
    hp: 60, mp: 0, atk: 5, spd: 50, def: "50%", crit: "5%", eva: "5%",
  ),
  EnemyInfo(
    name: "Exzatyl",
    ...
    hp: 65, mp: 0, atk: 15, spd: 90, def: "20%", crit: "20%", eva: "5%",
  ),
  EnemyInfo(
    ...
    hp: 130, mp: 0, atk: 15, spd: 90, def: "15%", crit: "5%", eva: "20%",
  ),
  EnemyInfo(
    name: "Monrocks",
    biome: "Cuevas Cristalinas",
    ...
    hp: 80, mp: 0, atk: 20, spd: 0, def: "40%", crit: "5%", eva: "0%",
  ),
  EnemyInfo(
    ...
    hp: 45, mp: 0, atk: 10, spd: 120, def: "15%", crit: "10%", eva: "15%",
  ),
];
